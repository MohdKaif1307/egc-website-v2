  ...
  return (
    <>
      <Hero
        ...
        title="Contact Us"
        subtitle="Get in touch with our team of experts. We're here to help you succeed."
              ...
              <div className="space-y-8">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="tel:+918527273997" className="text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
                      +91 85272 73997
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="mailto:support@egcworld.in" className="text-gray-600 dark:text-gray-300 hover:text-green-600 dark:hover:text-green-400 transition-colors">
                      support@egcworld.in
                    </a>
                  </div>
                </div>
                ...
                {/* Address */}
                <div className="flex items-start">
                  <div className="w-12 h-12 bg-purple-100 dark:bg-purple-900/40 rounded-lg flex items-center justify-center mr-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-300">
                      606, Eros City Square, Gurugram, Haryana, 122018
                    </p>
                  </div>
                </div>
                ...
                {/* Business Hours */}
                <div className="flex items-start">
                  <div className="w-12 h-12 bg-orange-100 dark:bg-orange-900/40 rounded-lg flex items-center justify-center mr-4">
                    <svg className="w-6 h-6 text-orange-600 dark:text-orange-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                  </div>
                  <div>
                    <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">Business Hours</h3>
                    <p className="text-gray-600 dark:text-gray-300">
      ...
      <section className="py-20 bg-gray-50 dark:bg-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="rounded-xl h-96 overflow-hidden shadow-lg">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3508.4837487806736!2d77.06513267549454!3d28.472044775745746!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390d19c8e32e0d01%3A0x1e43cead73fe4b45!2sEros%20City%20Square%20Mall!5e0!3m2!1sen!2sin!4v1704717600000!5m2!1sen!2sin"
              width="100%"
              height="100%"
              style={{ border: 0 }}
              ...
              title="EGC World Office Location - 614, Eros City Square, Gurugram"
      ...
      {/* CTA Section */}
      <section className="text-white py-20" style={{backgroundColor: '#aaa784'}}> 
