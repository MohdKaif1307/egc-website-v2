...
export default function ConsultingService() {
  return (
    <>
      ...
      {/* Service Overview */}
      <section className="py-20 bg-gray-50 dark:bg-primary-500">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-2">Assessment</h3>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-2">Strategy</h3>
              <p className="text-gray-600 dark:text-gray-300">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-2">Implementation</h3>
              <p className="text-gray-600 dark:text-gray-300">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-2">Optimization</h3>
              <p className="text-gray-600 dark:text-gray-300">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-4">Strategic Planning</h3>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-4">Operational Excellence</h3>
              <p className="text-gray-600 dark:text-gray-300 mb-4">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-4">Organizational Development</h3>
              <p className="text-gray-600 dark:text-gray-300 mb-4">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-4">Financial Advisory</h3>
              <p className="text-gray-600 dark:text-gray-300 mb-4">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-2">Expert Knowledge</h3>
              <p className="text-gray-600 dark:text-gray-300">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-2">Personalized Approach</h3>
              <p className="text-gray-600 dark:text-gray-300">
